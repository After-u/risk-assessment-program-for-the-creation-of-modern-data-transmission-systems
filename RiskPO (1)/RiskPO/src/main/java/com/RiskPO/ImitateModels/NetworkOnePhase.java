...
public class NetworkOnePhase {
    private static final int NUMBER_OF_PHASES = 1;
    ...
    public NetworkOnePhase(int NUMBER_OF_CHANNELS, double SERVICE_RATE, int SIMULATION_TIME, int MAX_QUEUE_SIZE) {
        this.NUMBER_OF_CHANNELS = NUMBER_OF_CHANNELS;
        this.SERVICE_RATE = SERVICE_RATE;
        this.SIMULATION_TIME = SIMULATION_TIME;
        this.MAX_QUEUE_SIZE = MAX_QUEUE_SIZE;
...
class Customers {
    ...
    public Customers(int arrivalTime) {
